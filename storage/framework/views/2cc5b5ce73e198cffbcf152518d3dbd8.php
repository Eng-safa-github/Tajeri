            ...
            <div class="col-lg-12">
                <div class="card ">
                    <div class="card-header d-flex justify-content-between align-items-center ">
                        ...
                        <?php if( auth()->user()->can('انشاء-المستخدمين') ): ?>

                            <a href="<?php echo e(route('users.create')); ?>" class="icon text-dark">
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\tajeri\resources\views/user/index.blade.php ENDPATH**/ ?>