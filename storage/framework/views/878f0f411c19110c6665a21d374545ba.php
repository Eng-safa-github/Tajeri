        ...
        <div class="authentication-inner py-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- /Logo -->
                    <h4 class="mb-2">مرحباً بك في موقع السوق  👋</h4>
                    <form id="formAuthentication" class="mb-3" onsubmit="return false" method="POST">
                        <div class="mb-3">
                            <label for="number" class="form-label">البريد الالكتروني</label>
                            <input type="text" class="form-control" id="email" name="email"
                                   placeholder="أدخل البريد الالكتروني الخاص بك" aria-describedby="phone" autofocus />
                        </div>
...
<?php /**PATH D:\laravelProjects\Tajeri-web\resources\views/auth/login.blade.php ENDPATH**/ ?>