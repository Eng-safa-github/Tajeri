        ...
        <?php if( auth()->user()->can('عرض الكل-لوحة_التحكم') ): ?>
            ...
            <li class="menu-item ">
                ...
                <ul class="menu-sub" id="dashboard">
                    <li class="menu-item">
                        <a href="<?php echo e(route('dashboard.view')); ?>" class="menu-link">
                            <div> لوحة التحكم</div>
                        </a>
                    </li>
                </ul>
        ...
        <?php if( auth()->user()->can('عرض الكل-الطلبات') ): ?>
            <li class="menu-item ">
                ...
                <ul class="menu-sub" id="orders">
                    <li class="menu-item">
                        <a href="<?php echo e(route('orders.view')); ?>" class="menu-link">
        ...
        <?php if( auth()->user()->can('عرض الكل-المنتجات') ): ?>
            <li class="menu-item ">
                ...
                <ul class="menu-sub" id="products">
                    <li class="menu-item">
                        <a href="<?php echo e(route('products.view')); ?>" class="menu-link">
                ...
                <ul class="menu-sub" id="category">
                    <li class="menu-item">
                        <a href="<?php echo e(route('categories.view')); ?>" class="menu-link">
        ...
        <?php if( auth()->user()->can('عرض الكل-المخازن') ): ?>
            <li class="menu-item ">
                ...
                <ul class="menu-sub" id="stores">
                    <li class="menu-item">
                        <a href="<?php echo e(route('stores.view')); ?>" class="menu-link">
...
<!-- / Menu -->
<?php /**PATH D:\laravelProjects\Tajeri-web\resources\views/panels/sidebar.blade.php ENDPATH**/ ?>